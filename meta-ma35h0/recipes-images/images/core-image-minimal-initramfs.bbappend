...
python do_deploy() {
    ...
    if d.getVar('SECURE_BOOT') == "no":
        ...
        subprocess.run(f"rm -rf $(date '+%m%d-*')", shell=True, check=True)
        if os.path.exists(os.path.join(d.getVar('DEPLOY_DIR_IMAGE'),"enc_bl2-ma35h0-spinand.dtb")):
            os.remove(os.path.join(d.getVar('DEPLOY_DIR_IMAGE'),"enc_bl2-ma35h0-spinand.dtb"))
            os.remove(os.path.join(d.getVar('DEPLOY_DIR_IMAGE'),"enc_bl2-ma35h0-spinand.bin"))
    else:
        ...
        shutil.copy("conv/enc_bl2-ma35h0.dtb","enc_bl2-ma35h0-spinand.dtb")
        shutil.copy("conv/enc_bl2-ma35h0.bin","enc_bl2-ma35h0-spinand.bin")
        ...
        pack_data["image"][1]["file"]="enc_bl2-ma35h0-spinand.dtb"
        pack_data["image"][2]["file"]="enc_bl2-ma35h0-spinand.bin"
